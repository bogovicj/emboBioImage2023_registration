...
\usepackage{listings}
\lstset{language=Java,basicstyle=\ttfamily\bfseries}
...
\begin{frame}{What is a transformation}
    ...
    \only<2>{
            \vspace{1em}  
            \includegraphics[height=0.7\paperheight]{figures/transforms/TransformsCoordinateSystem-3.pdf}
    }
...
\begin{frame}{Multi-resolution registration}
    ...
    \vspace{1.0em}
    \begin{center}
        \includegraphics[width=0.6\paperwidth]{figures/emboBiaCourse2023/elastix_multires.png} \\
    \end{center}
...
\begin{frame}{Optimization}
    ...
    \vspace{1.0em}
    \begin{center}
        \includegraphics[width=0.6\paperwidth]{figures/emboBiaCourse2023/elastix_optimization.png} \\
    \end{center}
...
%\end{frame}
%
%\begin{frame}[fragile]{Elastix parameters (2)}
%
%    \tiny
%    \begin{lstlisting}
%
...
\begin{frame}{We will learn}
    ...
    \begin{textblock}{4}(12,2.5)
        \includegraphics[width=1in]{figures/elastixLogo.png}
    \end{textblock}
...
\begin{frame}{Practical outline}
    ...
    \only<1>{
    \begin{textblock}{4}(8.4,2.5)
        \includegraphics[width=2.8in]{figures/emboBiaCourse2023/resample.png}
    \end{textblock}
    }

    \only<2>{
    \begin{textblock}{4}(8.4,2.5)
        \includegraphics[width=2.8in]{figures/emboBiaCourse2023/translation_initialization.png}
    \end{textblock}
    }

    \only<3>{
    \begin{textblock}{4}(8.7,2.5)
        \includegraphics[width=2.0in]{figures/emboBiaCourse2023/similarity_metrics.png}
    \end{textblock}
    }

    \only<4>{
    \begin{textblock}{4}(8.7,2.5)
        \includegraphics[width=2.5in]{figures/emboBiaCourse2023/multi_resolution.png}
    \end{textblock}
    }

    \only<5>{
    \begin{textblock}{4}(8.9,2.1)
        \includegraphics[width=1.7in]{figures/emboBiaCourse2023/nonlinear.png}
    \end{textblock}
    }
\end{frame}
